  ...
  return (
    <>
      ...
      <Typography component="p" sx={{ mb: 2 }}>
        ...
        . This page does a better job of explaining basic mechanics than I ever
        could.
      </Typography>
      <Typography component="p" sx={{ mb: 2 }}>
        Before we go into specific loadouts for each rank and talk about playing
        somewhat optimally we are going to go over a few points we consider
        important to new player that may not be mentioned in the
      ...
      <ul>
        ...
        <li>
          ...
          Essences in StQ are incredibly important, using essences that increase
          your damage output specifically can make your experience in StQ far
          better. Essences remain active as long as you remain in the instance
          you applied it in, don&apos;t switch jobs, and don&apos;t click it
          off.{" "}
        </li>
        <li>
          <b>Always use actions when possible (preferably good ones):</b> Same
          reason as essences but actions will stay equipped equipped forever as
          long as you do not overwrite them.{" "}
        </li>
        <li>
          <b>
          ...
          At base camp there is an NPC named the Resistance Quartermaster. This
          NPC allows you to trade in Bozjan Clusters for various items. Most
          items on this NPC are not important for you right away except for two,
          the riding maps. There are two maps for 25 clusters each and both are
          essential for getting to skirmishes faster. Getting 25 clusters to at
          least get the BSF map should be one of your earliest goals as it will
          speed up your grind significantly.{" "}
        </li>
        <li>
