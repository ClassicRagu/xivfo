...
export const fragments: { [key: string]: Fragments } = {
  ...
  Resolve: { FarmType: "CE", IsStandardFarm: false, FarmZones: ["BSF"], BSF: [bsfResolveCEs] },
  Mastery: { FarmType: "CLL", IsStandardFarm: false, FarmZones: ["BSF"], CLL: true },
  Sagacity: { FarmType: "CLL", IsStandardFarm: false, FarmZones: ["BSF"], CLL: true },
  Superstition: { FarmType: "CLL", IsStandardFarm: false, FarmZones: ["BSF"], CLL: true },
  Transcendence: { FarmType: "CLL", IsStandardFarm: false, FarmZones: ["BSF"], CLL: true },
  Becoming: { FarmType: "CLL", IsStandardFarm: false, FarmZones: ["BSF"], CLL: true },
  Caprice: { FarmType: "CLL", IsStandardFarm: false, FarmZones: ["BSF"], CLL: true },
  Clarity: { FarmType: "Cluster", IsStandardFarm: true, FarmZones: ["BSF"], DR: true, Quartermaster: true },
  Contention: { FarmType: "Cluster", IsStandardFarm: true, FarmZones: ["BSF"], DR: true, Quartermaster: true },
  Deception: { FarmType: "DRS", IsStandardFarm: false, FarmZones: ["BSF"], DRS: true },
  Divinity: { FarmType: "Cluster", IsStandardFarm: true, FarmZones: ["BSF"], DR: true, Quartermaster: true },
  Finesse: { FarmType: "Cluster", IsStandardFarm: true, FarmZones: ["BSF"], DR: true, Quartermaster: true },
  Fortitude: { FarmType: "Cluster", IsStandardFarm: true, FarmZones: ["BSF"], DR: true, Quartermaster: true },
  Loss: { FarmType: "DR", IsStandardFarm: false, FarmZones: ["BSF"], DR: true },
  Observation: { FarmType: "Cluster", IsStandardFarm: true, FarmZones: ["BSF"], DR: true, Quartermaster: true },
  Hope: { FarmType: "Cluster", IsStandardFarm: true, FarmZones: ["BSF"], Quartermaster: true },
  Moonlight: { FarmType: "Normal", IsStandardFarm: true, FarmZones: ["Zadnor"], Zadnor: [zadnorMonsterLocations.Zone2.Normal] },
  Rage: {
    IsStandardFarm: true,
    FarmType: "Normal",
    FarmZones: ["Zadnor"],
  ...
  Desperation: { FarmType: "Normal", IsStandardFarm: true, FarmZones: ["Zadnor"], Zadnor: [zadnorMonsterLocations.Zone3.Normal] },
  Tenacity: { FarmType: "CE", IsStandardFarm: false, FarmZones: ["Zadnor"], Zadnor: [zadnorTenacityCEs] },
  History: {
    FarmType: "Sprite",
    IsStandardFarm: true,
    FarmZones: ["Zadnor"],
  ...
  Heroism: { FarmType: "Dal", IsStandardFarm: false, FarmZones: ["Zadnor"], Dal: true },
  Cunning: { FarmType: "Dal", IsStandardFarm: false, FarmZones: ["Zadnor"], Dal: true },
  Revelation: { FarmType: "Dal", IsStandardFarm: false, FarmZones: ["Zadnor"], Dal: true },
  All_BSF: {
    FarmType: "",
